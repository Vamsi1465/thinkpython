...
avg_pace = 6.2
print(total_seconds)
avg_pace_in_seconds = total_seconds / avg_pace
avg_pace_minutes = avg_pace_in_seconds // 60
avg_pace_seconds = avg_pace_in_seconds % 60
