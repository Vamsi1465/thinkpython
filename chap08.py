...
Original file is located at
    https://colab.research.google.com/github/AllenDowney/ThinkPython/blob/v3/chapters/chap08.ipynb
...
def check_word(target_word, guesses):
    for guess, feedback in guesses:
        for i in range(5):
            if feedback[i] == 0:
                ...
                if target_word[i] == guess[i] or target_word.find(guess[i]) == -1:
                    return False
            elif feedback[i] == 2:
                if target_word[i] != guess[i]:
                    return False
